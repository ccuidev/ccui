...
/* harmony default export */ var TopNavMenu3 = (component.exports);
...
TopNavMenu3.install = function (Vue) {
  Vue.component(TopNavMenu3.name, TopNavMenu3);
}; //  2、遍历注册所有的组件（依赖），全局时使用


var components = [TopNavMenu3];
