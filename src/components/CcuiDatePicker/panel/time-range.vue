<template>
  <transition
    ...
    <div
      v-show="visible"
      class="ccui-time-range-picker ccui-picker-panel ccui-popper"
      :class="popperClass">
      <div class="ccui-time-range-picker__content">
        <div class="ccui-time-range-picker__cell">
          <div class="ccui-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="ccui-time-range-picker__body ccui-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="ccui-time-range-picker__cell">
          <div class="ccui-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="ccui-time-range-picker__body ccui-time-panel__content">
            <time-spinner
      ...
      <div class="ccui-time-panel__footer">
        <button
          type="button"
          class="ccui-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="ccui-time-panel__btn confirm"
          @click="handleConfirm()"
