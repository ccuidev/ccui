<template>
  <div class="ccui-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <ccui-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="ccui-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="ccui-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="ccui-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="ccui-time-spinner__arrow ccui-icon-arrow-up"/>
        <i v-repeat-click="increase" class="ccui-time-spinner__arrow ccui-icon-arrow-down"/>
        <ul class="ccui-time-spinner__list" ref="hours">
          <li
            class="ccui-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="ccui-time-spinner__arrow ccui-icon-arrow-up"/>
        <i v-repeat-click="increase" class="ccui-time-spinner__arrow ccui-icon-arrow-down"/>
        <ul class="ccui-time-spinner__list" ref="minutes">
          <li
            class="ccui-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="ccui-time-spinner__arrow ccui-icon-arrow-up"/>
        <i v-repeat-click="increase" class="ccui-time-spinner__arrow ccui-icon-arrow-down"/>
        <ul class="ccui-time-spinner__list" ref="seconds">
          <li
